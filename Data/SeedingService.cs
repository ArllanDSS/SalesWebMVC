...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department(5, "Household");
            Department d6 = new Department(6, "Health");
            Department d7 = new Department(7, "Games");
            Department d8 = new Department(8, "Sports");
            Department d9 = new Department(9, "Music");
            Department d10 = new Department(10, "Food");
            ...
            Seller s5 = new Seller(5, "Donald Blue", "donal@gmail.com", new DateTime(2000, 1, 9), 4000.0, d5);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1997, 3, 4), 3000.0, d6);

            // SalesRecords
            SalesRecords r1 = new SalesRecords(1, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s1);
            SalesRecords r2 = new SalesRecords(2, new DateTime(2018, 09, 4), 7000.0, SaleStatus.Billed, s3);
            ...
            SalesRecords r5 = new SalesRecords(5, new DateTime(2018, 09, 21), 3000.0, SaleStatus.Billed, s2);
            SalesRecords r6 = new SalesRecords(6, new DateTime(2018, 09, 15), 2000.0, SaleStatus.Billed, s3);
            SalesRecords r7 = new SalesRecords(7, new DateTime(2018, 09, 28), 13000.0, SaleStatus.Billed, s4);
            SalesRecords r8 = new SalesRecords(8, new DateTime(2018, 09, 11), 4000.0, SaleStatus.Billed, s4);
            SalesRecords r9 = new SalesRecords(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.Pending, s2);
            SalesRecords r10 = new SalesRecords(10, new DateTime(2018, 09, 7), 9000.0, SaleStatus.Billed, s2);
